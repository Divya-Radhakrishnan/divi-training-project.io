...
public class MenuItemDaoSqlImpl implements MenuItemDao {
	...
	public static final String GET_ALL_MENUITEM_CUSTOMER = "select*from truyum.menu_item where menu_item.me_date_of_launch>'2021-01-30' and me_active='Yes';";
	...
	public static final String EDIT_MENUITEM = "update truyum.menu_item set me_name=?,me_price=?,me_active=?,me_date_of_launch=?,me_category=?,me_free_delivery=? where me_id=?";
	...
	public void modifyMenuItems(MenuItem menuItem) {
		...
		try {
			statement = connection.prepareStatement(EDIT_MENUITEM);
	...
	public static final String GET_MENUITEM = "select*from truyum.menu_item where menu_item.me_id=?";
